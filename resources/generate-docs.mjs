  ...
  sections: [
    {
      ...
      children: [
        ...
        bullet("Two side-by-side horizontal bar charts (back-to-back layout)"),
        bullet("Left chart: Income entries — horizontal bars sorted highest to lowest, purple"),
        bullet("Right chart: Expenditure entries — horizontal bars sorted highest to lowest, amber"),
        bullet("Each bar is labelled with the event/item name (Welsh when Welsh mode is active)"),
        bullet("Total income and total expenditure shown below each chart"),
        bullet("Year filter tabs: All Years / individual years — aggregates entries for selected scope"),
        bullet("All labels bilingual (English / Welsh) using labelWel when available"),
        divider(),
        ...
        new Table({
          ...
          rows: [
            tableRow(["Field", "Notes"], true),
            tableRow(["Event / Item Name (English)", "Free text — e.g. 'Summer Disco' or 'Reading Books'"]),
            tableRow(["Event / Item Name (Welsh)", "Optional Welsh translation — e.g. 'Disco yr Haf'"]),
        ...
        bullet("Edit button pre-populates the form with the selected entry (including Welsh label)"),
        ...
        bullet("Welsh label shown as a sub-line under the English label in the table"),
        pageBreak(),
        ...
        new Table({
          ...
          rows: [
            ...
            tableRow(["fundraising", "id, label, labelWel, type ('income'|'expenditure'), year, amount (pence), createdAt"]),
          ],
        }),
        new Paragraph({ spacing: { after: 100 } }),
        pageBreak(),
